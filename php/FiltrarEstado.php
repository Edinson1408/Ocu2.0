   ...
   <div class="row sideBar-body buscar">
     ...
     <a class="dropdown-toggle"   data-toggle="dropdown"><?php echo $rutaP; ?></a>
                                  <ul class="dropdown-menu dropdown-menu-right" >
                                      ...
                                      <li><a href="http://gestionx.com/erpx/Componentes/c_socio_negocio/#!/detail/<?php echo $key14['IdCliente'];?>" target="_blank"><i class="glyphicon glyphicon-user"></i> Datos Socio </a></li>
                     ...
                     <a href="ocurrencias.php?IdC=<?php echo $key14['IdCliente'];?>&ve=<?php echo $busqueda;?>" style="text-decoration: none;"> <div class="col-sm-9 col-xs-9 sideBar-main">
                        <div class="row">
                          <div class="col-sm-10 col-xs-10 sideBar-name" style="overflow: hidden;float: left;">
                            <span class="name-meta" style=""><?php echo $key14['NombreSocio'] ; ?>
                          </span><br>
                          ...
                          <div class="col-sm-2 col-xs-2 pull-right sideBar-time">
                            <span class="time-meta pull-right"><?php 
